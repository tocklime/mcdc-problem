...
-- | large MCDC check -- does the valueassignment have good pairs for all variables?
hasMcdcCoverage :: Ord a => ValueAssignment a -> Bool
hasMcdcCoverage ass = all (hasMcdcPairFor ass) (allVarsInAssignment ass)

-- | Is the size of the ValueAssignment equal to one more than the number of variables?
